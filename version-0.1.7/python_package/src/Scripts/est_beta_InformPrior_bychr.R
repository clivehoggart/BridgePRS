...
option_list = list(
    ...
    make_option(c("--prior"), type="character",help="Prior stem", metavar="character"),
    ...
    make_option(c("-b", "--beta.stem"), type="character",help="Out file stem", metavar="character"),
    make_option(c("--fst"), type="numeric",help="Fst between populations", metavar="numeric",default=0.15),
    #make_option(c("--precision"), type="numeric", default=0,help="Logicial to calculate precision matrix of each clump",metavar="character"),
    ...
    make_option(c("--sumstats.P"), type="character", default="P",help="P-value column name", metavar="character"),
    ...
    make_option(c("--ranking"), type="character", default="p-value",help="Method to rank loci", metavar="character"),
...
for( chr in 1:22 ){
    ...
    #print(paste0(opt$prior,"_beta_bar_chr",chr,".txt.gz"))
    #print(unique(beta.prior$clump.id))
    #print(beta.prior) 
    #print('yoo') 
    #quit() 
    ...
    fits <- mclapply( 1:length(beta.prior),
                     function(i){
                         read.NonCentralFit.clump( beta.prior=beta.prior[[i]],
                                                  #do.ld.shrink=opt$ld.shrink,#recomb=recomb, Ne=opt$Ne,
                                                  do.ld.shrink=0, 
