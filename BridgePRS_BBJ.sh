...
eas_ld_ids=~/BridgePRS/1000G_EAS_ids.txt
...
do
	...
	--outdir /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/results/BBJ/1000G_ld/${pheno[$i]} \
	--strand_check 1 \
	--pop1 eur \
	--pop2 EAS \
	...
	--pop2_test_data /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/hapmap/phenotype/${pheno[$i]}/EAS-test.dat \
	--pop2_valid_data /sc/arion/projects/psychgen/projects/prs/cross_population_prs_development/quick_ridge/hapmap/phenotype/${pheno[$i]}/EAS-valid.dat \
	--cov_names $cov_names \
